...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#060606"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#060606"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#060606"),
    ...
    labelMinFontSize: kvLookup('labelMinFontSize', config, dataset, 16),

    // minLabelMinFontSize
    // absolute minimum font size for the minimum label
    minLabelMinFontSize: kvLookup('minLabelMinFontSize', config, dataset, 18),

    // maxLabelMinFontSize
    // absolute minimum font size for the maximum label
    maxLabelMinFontSize: kvLookup('maxLabelMinFontSize', config, dataset, 18),
